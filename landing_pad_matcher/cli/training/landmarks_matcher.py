...
def train(data_path: Path, batch_size: int, validation_batch_size: int,
    ...
    #            ('network.conv_head', 'network.bn2', 'network.act2')]
    # blocks_residuals = [1, 1, 2, 4, 3, 3, 1]
    ...
    #             fusable.append((f'network.blocks.{block}.{residual}.conv_pwl',
    #                             f'network.blocks.{block}.{residual}.bn3'))
