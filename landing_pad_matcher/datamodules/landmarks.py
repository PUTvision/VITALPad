...
class LandmarksDataModule(LightningDataModule):
    def __init__(self, data_path: Path, batch_size: int, validation_batch_size: int,
    ...
    def setup(self, stage: Optional[str] = None):
        self.train_dataset = LandmarksDataset(self._data_path, num_samples=500000)
        self.valid_dataset = LandmarksDataset(self._data_path, num_samples=50000)
